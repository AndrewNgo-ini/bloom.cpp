...
static struct ggml_cgraph * llm_build_bloom(
    ...
    const int64_t n_embd_head = hparams.n_embd_head();
    const int64_t n_embd_gqa  = hparams.n_embd_gqa();
    // const int64_t n_head_kv   = hparams.n_head; //fix for bloom
    // const int64_t n_embd_head = hparams.n_embd / hparams.n_head; //fix for bloom
    // const int64_t n_embd_gqa  = hparams.n_embd; //fix for bloom
